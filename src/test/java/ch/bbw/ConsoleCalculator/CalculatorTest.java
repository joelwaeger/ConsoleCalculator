...
public class CalculatorTest {
	...
	public void testSummeUeberMax_ValueIsOk(Calculator testee){
		assertEquals((long) Integer.MAX_VALUE + 1, testee.summe(2147483647, 1));
	}
	@Test
	public void testSummeUnterMin_ValueIsOk(Calculator testee){
		assertEquals((long) Integer.MIN_VALUE + 1, testee.summe(-2147483647, 1));
	}
	//Subtraction
	@Test
	...
	public void testSubtractionUnterMin_ValueIsOk(Calculator testee){
		assertEquals((long) Integer.MIN_VALUE + 1, testee.subtraction(-2147483647, 1));	}
	//Division
		@Test
		...
		public void testDivisionUnterMin_ValueIsOk(Calculator testee){
			assertEquals((long) Integer.MIN_VALUE + 1, testee.division(-2147483647, 1));		}
}
